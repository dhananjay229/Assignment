...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <button className=" hover:bg-slate-100 border shadow-sm rounded-full text-xl h-10 px-4 mx-2 dark:hover:bg-zinc-800 dark:text-white dark:ring-white dark:hover:ring-white dark:border-zinc-600" onClick={() => handleToggle()}>
